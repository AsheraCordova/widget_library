...
public class PlainMap implements java.io.Serializable, IFlatMap{
    ...
    private Object getElementFromMapPath(final Object elementObject,
        ...
        while (true) {
            ...
            if (newIndex >= 0) {
                ...
                currentElementObject = ((Map<String, ?>) com.ashera.widget.PluginInvoker.getMap(currentElementObject)).get(pathElement);
                ...
                if (PlainMap.ARRAY_LENGTH.equals(pathElement)) {
                    return Integer.toString(((List<?>) com.ashera.widget.PluginInvoker.getList(currentElementObject)).size());
                } else {
                    return ((Map<String, ?>) com.ashera.widget.PluginInvoker.getMap(currentElementObject)).get(pathElement);
                }
            }
        }
    }
